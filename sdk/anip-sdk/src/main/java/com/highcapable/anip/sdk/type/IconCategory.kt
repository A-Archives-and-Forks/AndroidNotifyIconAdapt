...
/**
 * Icon rule categories available from ANIP.
 */
enum class IconCategory {
    /** All loaded third-party app, game, and selected system icon rules. */
    ALL,

    /** Third-party app icon rules. */
    APP,

    /** Game icon rules. */
    GAME,

    /** Selected system icon rules. */
    SYSTEM
}